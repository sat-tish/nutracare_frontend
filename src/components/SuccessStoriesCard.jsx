    ...
    <div className="w-[90%] m-auto">
                <div key={props.key} className="w-[95%] pb-5">
                       <div  class="w-full flex flex-wrap gap-3 justify-center items-center bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                          ...
                          <img class="flex-1 rounded-sm w-[300px] md:max-w-[380px] p-5 m-auto" src={props.cardImage} alt="" />
                     
                      <div class="p-5 flex-1">
                          <a href="#">
                              <h5 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">{props.doctorName}</h5>
                          </a>
                          <p class="mb-3 text-sm font-medium text-gray-900 dark:text-gray-400">Speciality</p>
                          <p class="mb-3 text-sm font-normal text-gray-700 dark:text-gray-400">{props.street}, {props.suite}, {props.city}</p>
