                ...
                <div className="w-[95%] pb-5 bg-white border border-gray-300 rounded-lg shadow">
                       <div  className="w-full flex flex-wrap gap-x-5 xl:gap-x-[100px] items-center ">
                          <div className='max-md:m-auto'>
                             <img className=" rounded-[50%] w-[300px] h-[300px] p-5 " src={personOne} alt="" />
                          </div>
                  ...
                  <div className='flex flex-col p-5 gap-2'>
                    ...
                    <h1 className='font-semibold  mt-3'>Experience : </h1>
                     <p className='text-sm text-gray-700'>10 years of experience</p>
                     ...
                     <p className='text-sm text-gray-700'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium sed quae facere aliquam, ducimus dicta ad, assumenda neque minus eos, 
                      ...
                      <div className='flex'>
                        <div className='shrink-0'>
                          <img className="rounded-[50%] w-[90px] h-[90px] p-5" src={personOne} alt="" />
                        </div>
